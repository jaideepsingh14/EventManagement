...
class LocationTableGateway {
    ...
    public function insert($p) {
        $sql = "INSERT INTO locations(Name, Address, ManagerFName, ManagerLName, ManagerEmail, About, MaxCapacity) " .
                "VALUES (:Name, :Address, :ManagerFName, :ManagerLName, :ManagerEmail, :About, :MaxCapacity)";
