        ...
        <div class="content">
            <div class="container">
                ...
                <form action="editLocation.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="About" class="col-md-2 control-label">About Hotel</label><!--label-->
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="About" name="About" value="<?php echo $row['About']; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
