        ...
        <div class="content">
            <div class="container">
                ...
                <form action="createLocation.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="about" class="col-md-2 control-label">About Hotel</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="about" name="about" value="<?php echoValue($formdata, "about")?>" /><!--input-->
                        </div>
                        <div class="col-md-4">
                            <span id="mNumError" class="error"><!--error message for invalid input-->
                                <?php echoValue($errors, 'about');?>
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
